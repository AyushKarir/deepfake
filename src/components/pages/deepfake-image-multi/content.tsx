...
import {
    DeepfakeImageMultiRequestBodyProps,
    DeepfakeImageMultiResponseProps
} from "@/lib/types/deepfake-image-multi";
...
const Content = () => {
    ...
    useEffect(() => {
        const requestBody: DeepfakeImageMultiRequestBodyProps = {
            key: apiKey || "apiKey",
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const data: DeepfakeImageMultiResponseProps = await response.json();
            ...
            >
                ...
                {showCode && (
                    <>
                        ...
                        <ShowCodePanel
                            apiEndpoint="https://modelslab.com/api/v6/deepfake/multiple_face_swap"
