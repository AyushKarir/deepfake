...
import {
    DeepfakeImageSingleRequestBodyProps,
    DeepfakeImageSingleResponseProps
} from "@/lib/types/deepfake-image-single";
...
const Content = () => {
    ...
    useEffect(() => {
        const requestBody: DeepfakeImageSingleRequestBodyProps = {
            key: apiKey || "apiKey",
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const data: DeepfakeImageSingleResponseProps = await response.json();
